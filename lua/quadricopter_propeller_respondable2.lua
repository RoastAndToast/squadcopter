function sysCall_init() 
    propeller=sim.getObjectHandle('Quadricopter_propeller2')
    propellerRespondable=sim.getObjectHandle('Quadricopter_propeller_respondable2')
    propellerJoint=sim.getObjectHandle('Quadricopter_propeller_joint2')
