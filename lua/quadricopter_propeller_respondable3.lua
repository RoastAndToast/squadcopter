function sysCall_init() 
    propeller=sim.getObjectHandle('Quadricopter_propeller3')
    propellerRespondable=sim.getObjectHandle('Quadricopter_propeller_respondable3')
    propellerJoint=sim.getObjectHandle('Quadricopter_propeller_joint3')
