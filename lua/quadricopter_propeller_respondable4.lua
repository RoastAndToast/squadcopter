function sysCall_init() 
    propeller=sim.getObjectHandle('Quadricopter_propeller4')
    propellerRespondable=sim.getObjectHandle('Quadricopter_propeller_respondable4')
    propellerJoint=sim.getObjectHandle('Quadricopter_propeller_joint4')
